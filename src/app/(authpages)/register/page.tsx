...
import {
  GoogleSignInButton,
  EmailSignUpButton,
} from "firebase-nextjs/client/components";
...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-6 h-screen  bg-white text-black flex flex-col justify-center items-center transition-all p-2">
        ...
        <div className="flex flex-col border-b rounded-xl w-full  p-4 md:p-8 lg:p-10 py-10 items-center bg-white">
          {!currentUser ? (
            <>
              ...
              <h2 className="text-sm text-gray-500 mb-8 text-center">
